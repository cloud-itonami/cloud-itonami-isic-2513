...
`cloud-itonami-isic-2513` is an OSS open-business blueprint for
steam-generator/boiler plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a fabrication/welding/pressure-vessel-assembly-line-equipment action the governor refuses is never dispatched to hardware.
- the Steam Generator Plant Operations Governor remains independent of the advisor.
...
- bypassing fabrication/welding/pressure-vessel-assembly-line-equipment-control or record policy checks
