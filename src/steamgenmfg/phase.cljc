(ns steamgenmfg.phase
  "Phase 0->3 staged rollout for the industrial steam-generator/boiler
  ...
  consequence (a fabrication/welding/pressure-vessel-assembly/
  hydrotest-bench-equipment maintenance window means production
  downtime, and the equipment ends up actually touched); it is always
  a human plant supervisor's call. `steamgenmfg.governor`'s
  `equipment-actuate-blocked-violations` HARD-blocks actuate attempts
...
(defn verdict->disposition
  "Map a Steam Generator Plant Operations Governor verdict to a base
