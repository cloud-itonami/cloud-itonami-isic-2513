# Operator Quickstart — Manufacture of steam generators, except central heating hot water boilers

Shortest path from clone to a verified local dry-run for **ISIC 2513** (`cloud-itonami-isic-2513`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2513.git
cd cloud-itonami-isic-2513
```
...
- Blueprint governor key: `steam-generator-plant-operations-governor`
- Likely source path: `steamgenmfg.governor.cljc`
