# Business Model: Manufacture of steam generators, except central heating hot water boilers
...
## Classification
- Repository: `cloud-itonami-isic-2513` ([github.com/cloud-itonami/cloud-itonami-isic-2513](https://github.com/cloud-itonami/cloud-itonami-isic-2513))
- ISIC Rev.5: `2513` — Manufacture of steam generators, except central heating hot water boilers
- Domain: `:steam-generator/manufacturing`
- Social impact: :worker-safety :pressure-vessel-safety :boiler-explosion-safety :equipment-safety
- Actor: `:steam-generator-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :steam-generator/manufacturing — who wants
...
One managed tenant (:steam-generator/manufacturing):
...
- Do not bypass the `:steam-generator-plant-operations-governor` for production decisions.
